...
//                borderColor = Color.DARK_GRAY;
                ImageIcon wall = new ImageIcon("src/Pictures/wall.jpg");
                g.drawImage(wall.getImage(),0,0,60,60,this);
                break;
            case 0:
//                g.setColor(Color.WHITE);
//                g.fillRect(0, 0, getWidth(), getHeight());
                ImageIcon ground = new ImageIcon("src/Pictures/ground.jpg");
                g.drawImage(ground.getImage(),0,0,60,60,this);
...
//                g.drawPolygon(xPoints, yPoints, 4);
                ImageIcon grounds = new ImageIcon("src/Pictures/ground.jpg");
                g.drawImage(grounds.getImage(),0,0,60,60,this);
                ImageIcon target = new ImageIcon("src/Pictures/Target.png");
                g.drawImage(target.getImage(),0,0,50,50,this);
                break;
        }
